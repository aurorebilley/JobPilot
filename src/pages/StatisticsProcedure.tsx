...
export default function StatisticsProcedure() {
  ...
  useEffect(() => {
    const fetchStats = async () => {
      ...
      try {
        ...
        setProcedureCount(procSnap.size);
        ...
        await Promise.all(procSnap.docs.map(async (procDoc) => {
          ...
          // Count status
          if (procData.status === 'Procédure de recrutement 1') counts.procedure1++;
          else if (procData.status === 'Procédure de recrutement 2') counts.procedure2++;
          else if (procData.status === 'entretien') counts.entretien++;
          else if (procData.status === 'refusé') counts.refuse++;
          else if (procData.status === 'validé') counts.valide++;
          
          // Get linked candidature data
          if (procData.candidatureId) {
            const candRef = doc(db, 'candidatures', procData.candidatureId);
      ...
      <main className="flex-grow w-full py-6 px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          <div className="flex items-center gap-4 mb-4">
            ...
            <h1 className="text-3xl font-bold text-gray-900">Statistiques des procédures</h1>
          </div>
          ...
          <>
            <div className="bg-white shadow-lg rounded-xl p-6">
              <div className="flex items-start justify-between">
                <div>
                  <h2 className="text-4xl font-bold text-gray-900">{procedureCount}</h2>
                  <p className="text-lg text-gray-600">procédures</p>
                </div>
              </div>
            ...
            <div className="mt-8 grid grid-cols-2 md:grid-cols-3 gap-6">
              ...
              <div className="bg-white shadow-lg rounded-xl p-6">
                <h3 className="text-lg font-medium text-gray-900 mb-2">Entretiens</h3>
                <p className="text-4xl font-bold text-green-200">{statusCounts.entretien}</p>
              </div>
