...
export default function StatisticsRefuse() {
      ...
      <main className="flex-grow w-full py-6 px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          <div className="flex items-center gap-4 mb-4">
            ...
            <h1 className="text-3xl font-bold text-gray-900">Statistiques des candidatures refusées</h1>
          </div>
          ...
          <>
            <div className="bg-white shadow-lg rounded-xl p-6">
              <div className="flex items-start justify-between">
                <div>
                  <h2 className="text-4xl font-bold text-red-500">{refusedCount}</h2>
                  <p className="text-lg text-gray-600">candidatures refusées</p>
                </div>
              </div>
